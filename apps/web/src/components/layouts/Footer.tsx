...
function Footer() {
	...
	return (
		<Center style={{ flexDirection: "column", backgroundColor: colors.light, padding: "60px", gap: "10px" }}>
			...
			<Grid>
				<Grid.Col span={6}>
					<a href={Routes.DISCORD} rel="noopener noreferrer" style={{ margin: "12px 24px" }} target="_blank">
						<img alt="Discord Logo Link" height={50} src="/media/icons/discord.svg" width={50} />
					</a>
				</Grid.Col>
				<Grid.Col span={6}>
					<a href={Routes.TWITTER} rel="noopener noreferrer" style={{ margin: "12px 24px" }} target="_blank">
						<img alt="Twitter Logo Link" height={50} src="/media/icons/twitter.svg" width={50} />
					</a>
				</Grid.Col>
			</Grid>
		</Center>
