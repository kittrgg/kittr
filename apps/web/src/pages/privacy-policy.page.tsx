...
function PrivacyPolicy() {
	return (
		<PageWrapper description="kittr's Privacy Policy" title="Privacy Policy | kittr">
			<Styled.Container>
				...
				<p>
					...
					change your mind at any time. We will provide you with the ability to unsubscribe from our email-database or
					opt out of communications. Please be aware we may need to request specific information from you to help us
