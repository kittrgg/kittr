...
function Terms() {
  return (
    <PageWrapper
      description="kittr's Terms of Use"
      title="Terms of Use | kittr"
    >
      <Styled.Container>
        ...
        <p>
          ...
          kittr uses ‘cookies’. These cookies are used to store information
        ...
        <p>
          ...
          the Company should be sent to: 4957 N Highway 67, Sedalia CO 80135.
