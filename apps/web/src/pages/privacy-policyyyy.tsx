...
function PrivacyPolicy() {
  return (
    <PageWrapper
      description="kittr's Privacy Policy"
      title="Privacy Policy | kittr"
    >
      <Styled.Container>
        <h2>Privacy Policy</h2>
        <p>
          Your privacy is important to us. It is kittr's policy to respect your
          ...
          our website, <a href="https://kittr.gg">https://kittr.gg</a>, and
