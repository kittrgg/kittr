...
import { Button, Section, Text, TextInput, Title } from "@kittr/ui"
...
type GameInputs = {
	// TODO: is the correct way to allow indexing of objects in TS?
...
const Page = () => {
	...
	const handleInputChange = (e: EventTarget & HTMLInputElement, inputKey: string) => {
					...
					return (
						<>
							...
							<input
								...
								style={{ backgroundColor: colors.light, padding: "0.5rem", borderRadius: "10px", color: colors.white }}
							/>
						</>
					)
				}
