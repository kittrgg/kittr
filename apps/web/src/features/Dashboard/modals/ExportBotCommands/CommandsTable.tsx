...
import type { WarzoneCommandCode, WarzoneKit, WarzoneKitBase } from "@kittr/prisma"
...
function CommandsTable({ kits, includeMasterCommands = true, method, commandStrategy, includeUser }: Props) {
