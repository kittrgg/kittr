...
function TiktokId() {
	...
	const handleInput = (e: React.ChangeEvent<HTMLInputElement>) => {
		if (e.target.value.includes('vm.tiktok.com'))
			return dispatch(updateTiktokId(''));
	...
	return (
		<Styled.Container>
			...
			<Styled.ParagraphHelper>
				Enter the link to your tiktok below. We HIGHLY recommend that the video
				be about either this kit specifically or a general "loadouts" video.
			</Styled.ParagraphHelper>
			<TextInput
				...
				subline={
					"If you want to just copy-paste the whole Tiktok link, we'll trim it for you. We know, we know, you're welcome. (Note that we cannot accept links from the mobile app. If it starts with \"vm.tiktok.com\", it won't work!)"
				}
				sublineStyles={{
					color: colors.lighter,
					fontWeight: 'initial',
