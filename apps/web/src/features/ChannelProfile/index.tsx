...
function ChannelProfile() {
	...
	const { data: twitchInfo } = trpc.twitch["profile-page"].useQuery(twitchLink!, {
	...
	return (
		<Container>
			<Header {...channel} imagePath={coverPhotoPath} isLive={twitchInfo?.channelData.type === "live"} />
			...
			{isPremium ? (
				<>
					...
					<Specs brandColor={primaryColor} specs={channel.profile?.channelPcSpecs || []} />
