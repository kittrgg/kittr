...
const TESTIMONIALS = [
	...
	},
	{
		...
		role: 'Player',
		quote:
			"This site has been absolutely perfect for my community and I've received a handful of compliments on it.",
	},
	{
		name: 'CuddelzTV',
		role: 'Viewer',
...
function LastSection() {
	return (
		<section>
			...
			<Styled.P>
				STILL DON'TBELIEVE US? HERE'S WHAT THE COMMUNITY SAYS.
			</Styled.P>
			<Wrapper>
				<Scrolltainer>
