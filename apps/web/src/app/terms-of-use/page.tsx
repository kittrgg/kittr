...
function Page() {
  return (
    <div className="prose lg:prose-lg !prose-invert">
      ...
      <p>
        The kittr website located at https://kittr.gg is a copyrighted work
        belonging to In the Zone Development. Certain features of the Site may
      ...
      <p>
        ...
        section 1542 in connection with the foregoing, which states: &lsquo;a
        ...
        his or her settlement with the debtor.&rsquo;
      </p>

      <p>
        <strong>Cookies and Web Beacons.</strong> Like any other website, kittr
        uses &lsquo;cookies&rsquo;. These cookies are used to store information
      ...
      <p>
        ...
        Company should be sent to: 4957 N Highway 67, Sedalia CO 80135. After
