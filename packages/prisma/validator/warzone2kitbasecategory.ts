...
export interface CompleteWarzone2KitBaseCategory extends z.infer<typeof Warzone2KitBaseCategoryModel> {
 ...
 */
export const RelatedWarzone2KitBaseCategoryModel: z.ZodSchema<CompleteWarzone2KitBaseCategory> = z.lazy(() => Warzone2KitBaseCategoryModel.extend({
