...
import { CompleteWarzone2KitOption, RelatedWarzone2KitOptionModel, CompleteGame, RelatedGameModel, CompleteWarzone2KitBase, RelatedWarzone2KitBaseModel, CompleteChannel, RelatedChannelModel, CompleteChannelKitOverlay, RelatedChannelKitOverlayModel } from "./index"
 ...
 */
export const RelatedWarzone2KitModel: z.ZodSchema<CompleteWarzone2Kit> = z.lazy(() => Warzone2KitModel.extend({
