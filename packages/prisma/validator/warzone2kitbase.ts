...
import { CompleteGame, RelatedGameModel, CompleteWarzone2CommandCode, RelatedWarzone2CommandCodeModel, CompleteWarzone2KitOption, RelatedWarzone2KitOptionModel, CompleteWarzone2KitBaseCategory, RelatedWarzone2KitBaseCategoryModel, CompleteWarzone2Kit, RelatedWarzone2KitModel } from "./index"
...
export interface CompleteWarzone2KitBase extends z.infer<typeof Warzone2KitBaseModel> {
  game: CompleteGame
 ...
 */
export const RelatedWarzone2KitBaseModel: z.ZodSchema<CompleteWarzone2KitBase> = z.lazy(() => Warzone2KitBaseModel.extend({
