...
export interface CompleteWarzone2CommandCode extends z.infer<typeof Warzone2CommandCodeModel> {
 ...
 */
export const RelatedWarzone2CommandCodeModel: z.ZodSchema<CompleteWarzone2CommandCode> = z.lazy(() => Warzone2CommandCodeModel.extend({
