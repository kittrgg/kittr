...
import { CompleteGame, RelatedGameModel, CompleteWarzoneTwoCommandCode, RelatedWarzoneTwoCommandCodeModel, CompleteWarzoneTwoKitOption, RelatedWarzoneTwoKitOptionModel, CompleteWarzoneTwoKitBaseCategory, RelatedWarzoneTwoKitBaseCategoryModel, CompleteWarzoneTwoKit, RelatedWarzoneTwoKitModel } from "./index"
...
export interface CompleteWarzoneTwoKitBase extends z.infer<typeof WarzoneTwoKitBaseModel> {
  game: CompleteGame
 ...
 */
export const RelatedWarzoneTwoKitBaseModel: z.ZodSchema<CompleteWarzoneTwoKitBase> = z.lazy(() => WarzoneTwoKitBaseModel.extend({
