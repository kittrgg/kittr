...
import { CompleteKitOption, RelatedKitOptionModel, CompleteGame, RelatedGameModel, CompleteKitBase, RelatedKitBaseModel, CompleteChannel, RelatedChannelModel, CompleteChannelKitOverlay, RelatedChannelKitOverlayModel } from "./index"
 ...
 */
export const RelatedKitModel: z.ZodSchema<CompleteKit> = z.lazy(() => KitModel.extend({
